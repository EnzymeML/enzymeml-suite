...
/**
 * Extracts variable names from a plain text mathematical equation.
 *
 * @param {string} plainEquation - The plain text equation to parse.
...
/**
 * Converts underscore notation species IDs in an equation to their original format.
 *
 * @param {string} equation - The equation containing underscore notation species IDs.
 * @returns {Promise<string>} - A promise that resolves to the equation with species IDs in their original format.
 */
...
/**
 * Converts species IDs in an equation to underscore notation.
 *
 * @param {string} equation - The equation containing species IDs.
 * @returns {Promise<string>} - A promise that resolves to the equation with species IDs in underscore notation.
 */
